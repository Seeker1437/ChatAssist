...
return array(
    ...
    "FEEDBACK_CAPTCHA_WRONG" => "Failed to verify with reCaptcha prompt.",
    ...
    "FEEDBACK_PDF_GENERATED" => "The pdf report has been generated.",
    "FEEDBACK_ZIP_CODE_DOES_NOT_FIT_PATTERN" => "Your ZIP Code is should be 5 digits (or 9 digits, if you're using ZIP+4).",
    "FEEDBACK_ZIP_CODE_FIELD_EMPTY" => "ZIP code field was empty",
    "FEEDBACK_FIRST_NAME_FIELD_EMPTY" => "First Name field was empty",
    "FEEDBACK_LAST_NAME_FIELD_EMPTY" => "Last Name field was empty",
    "FEEDBACK_EMAIL_PDF_SENT_SUCCESSFUL" => "The PDF was sent successfully."
