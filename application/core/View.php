...
{
    /**
     * simply view (=shows) the view. this is done from the controller. In the controller, you usually say
    ...
    {
        echo '<div class="g-recaptcha" style="display: inline-block;" data-sitekey="'.Config::get('RECAPTCHA_SITEKEY').'"></div>';
    }
